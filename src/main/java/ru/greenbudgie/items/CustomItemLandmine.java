...
public class CustomItemLandmine extends RequesterCustomItem implements BlockHolder {
	...
	public ItemInfo getDescription() {
		return new ItemInfo("Мина, которая активируется при приближении врага к ней")
				.extra("Радиус активации: 5 блоков, задержка перед взрывом - 1.5 секунды. Сила взрыва примерно равна " +
						"динамиту. Можно установить на арене! Взрывается сильнее, если окружена блоками " +
						"со всех сторон, т.е. полностью зарыта.")
				.note("Нанесет тебе и тиммейту столько же урона, сколько и врагу, если будешь рядом! " +
						"Можно зарыть под землю и поставить блок грязи сверху - он сразу зарастет травой.");
	}
